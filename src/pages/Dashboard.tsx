...
import { Users, Calendar, Activity, AlertCircle, Bell, ChevronRight, Search } from 'lucide-react';
            ...
            <div className="max-w-7xl mx-auto p-8 space-y-10">
                ...
                <header className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                    <div className="space-y-2">
                        <div className="flex items-center gap-3">
                            ...
                            <span className="text-slate-500 dark:text-slate-500 text-[10px] font-black uppercase tracking-widest">Lundi 2 Mars, 2026</span>
                        </div>
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <button className="flex items-center gap-2 px-6 py-3 rounded-2xl bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-300 font-bold text-sm hover:shadow-lg hover:border-slate-300 dark:hover:border-slate-600 transition-all duration-300">
                            <Search size={18} />
                            <span>Rechercher</span>
                        </button>
                        <button className="flex items-center gap-2 px-6 py-3 rounded-2xl bg-blue-600 dark:bg-blue-600 text-white font-bold text-sm hover:bg-blue-700 dark:hover:bg-blue-500 transition-all duration-300 shadow-xl shadow-blue-600/20 dark:shadow-blue-500/10">
                            <Users size={18} />
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    <StatCard
                        ...
                        value="124"
                        subtitle="+4 nouveaux cette semaine"
                        icon={<Users size={24} />}
                        trend="+ 8%"
                        color="blue"
                    />
                ...
                <div className="space-y-8 bg-white/70 dark:bg-slate-900 p-8 rounded-[2.5rem] border border-slate-200 dark:border-slate-800 shadow-2xl shadow-slate-200/50 dark:shadow-black/20">
                    <div className="flex items-end justify-between border-b border-slate-100 dark:border-slate-800/50 pb-6">
                        ...
                        <button className="flex items-center gap-2 px-5 py-2.5 rounded-full bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 font-black text-[10px] uppercase tracking-widest hover:bg-blue-600 hover:text-white dark:hover:bg-blue-500 dark:hover:text-slate-950 transition-all duration-300 shadow-sm">
        ...
        <div className="w-full space-y-10">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                <div>
                    <h3 className="text-3xl font-black tracking-tight text-slate-900 dark:text-white leading-none">
                        Mars <span className="text-slate-300 dark:text-slate-700">2026</span>
                    </h3>
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div className="flex p-1 bg-slate-100 dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700">
                        <button className="px-6 py-2 rounded-lg text-[10px] font-black bg-white dark:bg-slate-700 text-slate-900 dark:text-white uppercase tracking-widest shadow-sm">Ce Mois</button>
                        <button className="px-6 py-2 rounded-lg text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest hover:text-slate-600 dark:hover:text-slate-300 transition-colors">Suivant</button>
                    </div>
                </div>
            </div>
            ...
            <div className="grid grid-cols-7 gap-y-6 sm:gap-y-8 text-center bg-slate-100/30 dark:bg-slate-800/20 p-8 rounded-[2rem] border border-slate-200/50 dark:border-slate-800/50 shadow-inner">
                ...
                {days.map(day => (
                    ...
                    >
                        {day === 12 && (
                            <div className="absolute top-0 right-1/4 w-1.5 h-1.5 rounded-full bg-blue-500 shadow-[0_0_10px_#3b82f6]" />
                        )}
                        {day === 18 && (
                        ...
                        <span className={`
                            ...
                            ${day === 2 ? 'bg-blue-600 text-white shadow-lg shadow-blue-500/20 scale-110' : 'text-slate-400 dark:text-slate-500 group-hover:bg-slate-200 dark:group-hover:bg-slate-800 group-hover:text-slate-800 dark:group-hover:text-white'}
                        `}>
                            {day < 10 ? `0${day}` : day}
                        </span>
                    </div>
